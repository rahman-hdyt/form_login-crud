      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <img src="<?= base_url('template') ?>/assets/img/SI.png" alt="logo" width="90" class="shadow-light rounded-circle">
            </div>
            ...
            <p style="color:white;">Kamu Tidak Memiliki Akun? <a href="<?= base_url('user/register') ?>" style="color:blue;">Buat Akun</a></p>
            </div>
